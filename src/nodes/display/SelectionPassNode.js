import { addNodeElement, nodeObject, tslFn } from '../shadernode/ShaderNode.js';
...
class SelectionPassNode extends PassNode {
	...
	updateBefore( frame ) {
		...
		const oldBackgroundNode = this.scene.backgroundNode;
		...
		this.scene.backgroundNode = oldBackgroundNode;
