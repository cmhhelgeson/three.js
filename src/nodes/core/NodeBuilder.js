...
class NodeBuilder {
	 ...
	 * @param {?string} [interpolationType] - Interpolation type of the varying.
	 * @param {?string} [interpolationSampling] - Interpolation sampling type of the varying.
